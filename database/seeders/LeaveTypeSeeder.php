...
class LeaveTypeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $types = [
            ...
            ['code' => 'SLP', 'name' => 'Special Leave Privileges', 'accrual_per_month' => 0, 'annual_max_credit' => 3, 'is_cumulative' => false, 'is_commutable' => false],
            ...
            ['code' => 'STUDY', 'name' => 'Study Leave', 'accrual_per_month' => 0, 'annual_max_credit' => null, 'is_cumulative' => true, 'is_commutable' => false],
        ...
        foreach ($types as $type) {
            DB::table('leave_types')->updateOrInsert(
                ['code' => $type['code']],
                $type + ['requires_approval' => true, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()]
            );
        }
    }
}
