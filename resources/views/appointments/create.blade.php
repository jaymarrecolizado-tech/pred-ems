...
@section('breadcrumbs')
    @include('partials.breadcrumbs', ['crumbs' => [['Dashboard', route('dashboard')], ['Employee Profiles', route('employees.index')], [$employee->full_name, route('employees.show', $employee)], ['Add Appointment']]])
@endsection
